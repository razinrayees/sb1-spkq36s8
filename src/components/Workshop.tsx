      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">
            Tech <span className="text-[#99CCFF]">Workshops</span>
          </h1>
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Learn from industry experts in Malayalam. Hands-on workshops designed for practical skill development.
          </p>
        </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4 text-white/80">
                      ...
                      <div className="flex items-center space-x-3">
                        <Users className="w-5 h-5 text-[#99CCFF]" />
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() => handleRegisterClick(workshop.titleEn)}
